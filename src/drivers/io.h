...
void io_set_out(GPIO_TypeDef *port, const uint32_t pin, const io_out_e state);  // Set output value HIGH or LOW
io_in_e io_get_input(GPIO_TypeDef *port, const uint32_t pin);     // Get the pin value
